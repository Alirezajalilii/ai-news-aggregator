"""
AI News Aggregator - The Verge AI Scraper
Scraper for The Verge AI section
"""
...
class TheVergeScraper(BaseScraper):
    ...
    async def parse_articles(self, soup: BeautifulSoup, url: str) -> List[ArticleData]:
        """Parse articles from The Verge AI section"""
        articles = []
        ...
        for card in article_cards[:20]:
            try:
                ...
                logger.debug(f"Error parsing The Verge article: {e}")
                continue
    ...
    def _extract_article(self, card, base_url: str) -> ArticleData:
        ...
        return ArticleData(
            ...
            tags=["AI", "The Verge", "Technology"]
        )


from src.scrapers.base import ScraperRegistry
ScraperRegistry.register("the_verge_ai", TheVergeScraper)
